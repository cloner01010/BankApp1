...
public interface Bank {
    ...
    void addTransaction(String account, Transaction transaction)
            throws TransactionAlreadyExistException, AccountDoesNotExistException, AccountAlreadyExistsException, IOException;
    ...
    void removeTransaction(String account, Transaction transaction)
            throws TransactionDoesNotExistException, AccountAlreadyExistsException, IOException;
     ...
     * @param transaction the transaction which is added to the account
     */
    boolean containsTransaction(String account, Transaction transaction) throws AccountAlreadyExistsException, IOException;
     ...
     */
    double getAccountBalance(String account) throws AccountAlreadyExistsException, IOException;
     ...
     */
    List<Transaction> getTransactions(String account) throws AccountAlreadyExistsException, IOException;
     ...
     * @return the list of transactions
     */
    List<Transaction> getTransactionsSorted(String account, boolean asc) throws AccountAlreadyExistsException, IOException;
     ...
     * @return the list of transactions
     */
    List<Transaction> getTransactionsByType(String account, boolean positive) throws AccountAlreadyExistsException, IOException;
    void writeAccount(String account) throws IOException, AccountAlreadyExistsException;
    void readAccount() throws IOException, AccountAlreadyExistsException;
